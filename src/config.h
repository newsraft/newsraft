...
CFG(CFG_COLOR_LIST_FEED_FAILED,          "color-list-feed-failed",          CFG_COLOR,  {.c = {COLOR_RED,     -1, A_NORMAL}})
...
CFG(CFG_COLOR_LIST_SECTION_FAILED,       "color-list-section-failed",       CFG_COLOR,  {.c = {COLOR_RED,     -1, A_NORMAL}})
