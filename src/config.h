...
CFG(CFG_COLOR_LIST_ITEM_SELECTED,        "color-list-item-selected",        CFG_COLOR,  {.c = {~0, ~0, ~0}})
...
CFG(CFG_COLOR_LIST_FEED_SELECTED,        "color-list-feed-selected",        CFG_COLOR,  {.c = {~0, ~0, ~0}})
...
CFG(CFG_COLOR_LIST_SECTION_SELECTED,     "color-list-section-selected",     CFG_COLOR,  {.c = {~0, ~0, ~0}})
...
CFG(CFG_DOWNLOAD_MAX_CONNECTIONS,        "download-max-connections",        CFG_UINT,   {.u = 500 })
...
CFG(CFG_GLOBAL_SECTION_HIDE,             "global-section-hide",             CFG_BOOL,   {.b = false})
