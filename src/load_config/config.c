...
static struct config_entry config[] = {
	...
	{"item-formation-order",            CFG_STRING,  {.s = {NULL, "feed,title,authors,published,updated,max-content", 48, NULL}}},
	...
	{"enter-explore-menu-on-startup",   CFG_BOOL,    {.b = false}},
	{"auto-advance-on-read",            CFG_BOOL,    {.b = true }},
	{"auto-advance-on-unread",          CFG_BOOL,    {.b = true }},
