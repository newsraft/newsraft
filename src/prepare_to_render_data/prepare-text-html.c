...
static const struct html_element_preparer preparers[] = {
	...
	{GUMBO_TAG_H1,         NULL,            NULL,             0, 0, "<b>",  "</b>"},
	{GUMBO_TAG_H2,         NULL,            NULL,             0, 0, "<b>",  "</b>"},
	{GUMBO_TAG_H3,         NULL,            NULL,             0, 0, "<b>",  "</b>"},
	{GUMBO_TAG_H4,         NULL,            NULL,             0, 0, "<b>",  "</b>"},
	{GUMBO_TAG_H5,         NULL,            NULL,             0, 0, "<b>",  "</b>"},
	{GUMBO_TAG_H6,         NULL,            NULL,             0, 0, "<b>",  "</b>"},
