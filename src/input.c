...
assign_default_binds(void)
{
	...
	if (assign_action_to_key("n",              1, INPUT_SELECT_NEXT_UNREAD)    == false) { goto fail; }
	if (assign_action_to_key("p",              1, INPUT_SELECT_PREV_UNREAD)    == false) { goto fail; }
	if (assign_action_to_key("N",              1, INPUT_SELECT_NEXT_IMPORTANT) == false) { goto fail; }
	if (assign_action_to_key("P",              1, INPUT_SELECT_PREV_IMPORTANT) == false) { goto fail; }
	...
	if (assign_action_to_key("d",              1, INPUT_MARK_READ)             == false) { goto fail; }
	if (assign_action_to_key("D",              1, INPUT_MARK_UNREAD)           == false) { goto fail; }
